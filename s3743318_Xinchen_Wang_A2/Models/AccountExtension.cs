...
namespace WebBankingApp.Models
{
    public static class AccountExtension
    {
        ...
        public static int GetTotalTransactions(this Customer customer)
        {
        ...
        public static decimal GetDiffBalance(decimal previousBalance, decimal currentBalance)
        {
            ...
            return Math.Abs(previousBalance - currentBalance);
        }

        public static int GetDiffTransactions(int previousCount, int currentCount)
        {
